		...
		<Dashboard>
			...
			{#if isPanelVisible('politics')}
				<div class="panel-slot">
					<NewsPanel category="politics" panelId="politics" title={$t('panels.politics')} />
				</div>
			{/if}

			{#if isPanelVisible('tech')}
				<div class="panel-slot">
					<NewsPanel category="tech" panelId="tech" title={$t('panels.tech')} />
				</div>
			{/if}

			{#if isPanelVisible('finance')}
				<div class="panel-slot">
					<NewsPanel category="finance" panelId="finance" title={$t('panels.finance')} />
				</div>
			{/if}

			{#if isPanelVisible('gov')}
				<div class="panel-slot">
					<NewsPanel category="gov" panelId="gov" title={$t('panels.gov')} />
				</div>
			{/if}

			{#if isPanelVisible('ai')}
				<div class="panel-slot">
					<NewsPanel category="ai" panelId="ai" title={$t('panels.ai')} />
				</div>
			{/if}
			...
			{#if isPanelVisible('venezuela')}
				<div class="panel-slot">
					<SituationPanel
						panelId="venezuela"
						config={{
							title: $t('panels.venezuela'),
							subtitle: $t('situation.venezuela_subtitle'),
			...
			{#if isPanelVisible('greenland')}
				<div class="panel-slot">
					<SituationPanel
						panelId="greenland"
						config={{
							title: $t('panels.greenland'),
							subtitle: $t('situation.greenland_subtitle'),
			...
			{#if isPanelVisible('iran')}
				<div class="panel-slot">
					<SituationPanel
						...
						config={{
							title: $t('panels.iran'),
							subtitle: $t('situation.iran_subtitle'),
							criticalKeywords: [
								'protest',
								'uprising',
								'revolution',
